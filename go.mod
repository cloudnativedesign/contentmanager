...
require github.com/cloudnativedesign/contentmanager/server v0.0.0

require (
	github.com/cloudnativedesign/contentmanager/server/controllers v0.0.0-unpublished // indirect
	github.com/cloudnativedesign/contentmanager/server/models v0.0.0-unpublished // indirect
